...
BEGIN
	IF ope = 1 THEN
		INSERT INTO cliente (cli_codigo,cli_nomape,cli_domici,cli_telefo,cli_telef1,cli_cuit) VALUES (codigo,nombre,domici,telefo);
	ELSE IF ope = 2 THEN
...
-- Dump completed on 2015-05-15 17:11:40
