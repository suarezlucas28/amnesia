...
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `abm_articulos`(IN ope INT, IN codigo INT, IN descri VARCHAR(50), IN clasif INT, IN minori FLOAT(10,2), in estado varchar(2))
BEGIN
	IF ope = 1 THEN
...
-- Dump completed on 2015-05-15 20:00:43
