...
private void operaciones (){
        try {
            String SQL = "call abm_proveedor("+operacion+","+txtcodigo.getText()+",'"+txtnombre.getText()+"')";
...
txtnombre.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(505, 166));
        setMinimumSize(new java.awt.Dimension(505, 166));
        setPreferredSize(new java.awt.Dimension(505, 166));
